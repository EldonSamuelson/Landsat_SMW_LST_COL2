...
// ##UPDATER DISCLAIMER##
// These coefficients have been generated by averaging the previous values above, instead of using the SMW Algorithim or Calibration methods used by the Original Author
// Trust these values at your own risk!
exports.coeff_SMW_L9 = ee.FeatureCollection([
  ee.Feature(null, {'TPWpos': 0, 'A': 0.9759, 'B': -205.2948, 'C': 211.9263}),
  ee.Feature(null, {'TPWpos': 1, 'A': 1.0169, 'B': -234.2363, 'C': 230.3959}),
  ee.Feature(null, {'TPWpos': 2, 'A': 1.0695, 'B': -257.8568, 'C': 239.3624}),
  ee.Feature(null, {'TPWpos': 3, 'A': 1.1533, 'B': -287.2674, 'C': 244.9649}),
  ee.Feature(null, {'TPWpos': 4, 'A': 1.2324, 'B': -318.2054, 'C': 253.1705}),
  ee.Feature(null, {'TPWpos': 5, 'A': 1.3721, 'B': -364.0081, 'C': 258.7328}),
  ee.Feature(null, {'TPWpos': 6, 'A': 1.5172, 'B': -412.7765, 'C': 265.3434}),
  ee.Feature(null, {'TPWpos': 7, 'A': 1.7155, 'B': -475.8340, 'C': 270.9619}),
  ee.Feature(null, {'TPWpos': 8, 'A': 1.5942, 'B': -444.6960, 'C': 277.4406}),
  ee.Feature(null, {'TPWpos': 9, 'A': 2.0330, 'B': -575.2736, 'C': 280.2798})
]);
